...
const AppFeatures = () => {
  ...
  return (
    <section className="w-full bg-[#FDFBF7] py-24 px-6 md:px-10 border-t border-[#E0F2FE] relative overflow-hidden">
      
      {/* Background Element */}
      <div className="absolute bottom-0 right-0 w-96 h-96 bg-[#0EA5E9] rounded-full blur-[200px] opacity-10 pointer-events-none"></div>
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl md:text-5xl font-bold text-slate-900 mb-6 leading-tight">
            Designed Around Your <span className="text-[#0EA5E9]">Financial Needs</span>
          </h2>
        </div>
