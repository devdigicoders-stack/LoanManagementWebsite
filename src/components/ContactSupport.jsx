...
const ContactSupport = () => {
  ...
  return (
    <section className="w-full bg-[#0b0f0e] py-24 px-6 md:px-10 border-t border-b border-[#1a241c]">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-12 lg:gap-20 items-center">
        ...
        <div className="w-full lg:w-5/12">
          ...
          <h2 className="text-3xl md:text-5xl font-bold text-white mb-6 leading-tight">
            ...
            <span className="text-[#5bc116]">Our Services?</span>
          </h2>
          ...
          <div className="bg-[#111814] border border-[#1a241c] p-6 rounded-2xl flex gap-4">
            <div className="text-[#5bc116] shrink-0 mt-1">
              <AlertCircle size={24} />
            </div>
            <div>
        ...
        <div className="w-full lg:w-7/12">
          <div className="bg-[#111814] border border-[#1a241c] rounded-3xl p-8 md:p-10 relative overflow-hidden">
            
            <div className="absolute top-0 right-0 w-64 h-64 bg-[#5bc116] rounded-full blur-[150px] opacity-10 pointer-events-none"></div>

            <h3 className="text-xl font-bold text-white mb-8">Our support team can help with:</h3>
            
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 relative z-10">
              {supportItems.map((item, index) => (
                <div key={index} className="flex items-center gap-3 bg-[#0b0f0e] p-4 rounded-xl border border-[#1a241c] hover:border-[#2a3a2c] transition-colors">
                  <CheckCircle2 className="text-[#5bc116] shrink-0" size={18} />
