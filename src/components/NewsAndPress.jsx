    ...
    <section className="w-full bg-[#fafdf9] py-20 px-6 md:px-10">
      <div className="max-w-7xl mx-auto">
          ...
          {newsData.map((news, index) => (
            ...
            >
              ...
              <div className="flex items-center gap-4 mb-5 text-sm">
                ...
                <span className="text-[#0284C7] font-semibold">{news.category}</span>
              </div>

              {/* Content */}
              <h3 className="text-xl font-bold text-slate-900 mb-4 group-hover:text-[#0284C7] transition-colors leading-snug">
                {news.title}
              </h3>
              ...
              {/* Read More Link */}
              <a href="#" className="inline-flex items-center gap-2 text-slate-800 font-bold text-sm mt-auto group-hover:text-[#0284C7] transition-colors w-max">
                Read Article
                <span className="w-6 h-6 rounded-full bg-gray-100 group-hover:bg-[#0284C7]/10 flex items-center justify-center transition-colors">
                  <ArrowRight size={12} />
                </span>
              </a>
            </div>
        ...
        <div className="mt-8 flex justify-center md:hidden">
          <Link to="#" className="flex items-center gap-2 text-sm font-bold text-slate-800 hover:text-[#0284C7] transition-colors group">
            View All News
            <ArrowRight size={18} className="transform group-hover:translate-x-1 transition-transform" />
          </Link>
        </div>
