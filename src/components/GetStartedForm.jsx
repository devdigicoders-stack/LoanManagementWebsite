...
const GetStartedForm = () => {
  return (
    <section id="enquiry-form" className="w-full bg-[#0b0f0e] py-24 px-6 md:px-10 border-t border-[#1a241c]">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl md:text-5xl font-bold text-white mb-6 leading-tight">
            Basic <span className="text-[#5bc116]">Information</span>
          </h2>
          <p className="text-gray-400 text-[16px] leading-relaxed max-w-2xl mx-auto">
        ...
        <div className="bg-white rounded-3xl p-8 md:p-12 shadow-2xl relative overflow-hidden">
          {/* Decorative Corner */}
          <div className="absolute top-0 right-0 w-32 h-32 bg-[#e8fbe9] rounded-bl-full opacity-50 pointer-events-none"></div>
          ...
          <form className="space-y-10 relative z-10">
            ...
            <div>
              <h3 className="text-xl font-bold text-gray-900 mb-6 border-b border-gray-100 pb-3 flex items-center gap-2">
                <User size={20} className="text-[#5bc116]" /> Personal Details
              </h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <input type="tel" placeholder="Enter your 10-digit mobile number" className="w-full pl-11 pr-4 py-3 bg-[#fcfcfc] border border-gray-200 rounded-xl focus:outline-none focus:border-[#5bc116] focus:ring-1 focus:ring-[#5bc116] transition-all" />
                  </div>
                </div>
                <div className="space-y-2">
            ...
            <div>
              <h3 className="text-xl font-bold text-gray-900 mb-6 border-b border-gray-100 pb-3 flex items-center gap-2">
                <Building size={20} className="text-[#5bc116]" /> Property Details
              </h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                ...
                <div className="space-y-2 md:col-span-2">
                  ...
                  <div className="relative">
                    ...
                    <input type="text" placeholder="Enter approximate property value" className="w-full pl-11 pr-4 py-3 bg-[#fcfcfc] border border-gray-200 rounded-xl focus:outline-none focus:border-[#5bc116] focus:ring-1 focus:ring-[#5bc116] transition-all" />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div>
              <h3 className="text-xl font-bold text-gray-900 mb-6 border-b border-gray-100 pb-3 flex items-center gap-2">
                <Briefcase size={20} className="text-[#5bc116]" /> Financial Details
              </h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <IndianRupee className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400" size={18} />
                    <input type="text" placeholder="Enter approximate required amount" className="w-full pl-11 pr-4 py-3 bg-[#fcfcfc] border border-gray-200 rounded-xl focus:outline-none focus:border-[#5bc116] focus:ring-1 focus:ring-[#5bc116] transition-all" />
                  </div>
                </div>
                <div className="space-y-2">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <IndianRupee className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400" size={18} />
                    <input type="text" placeholder="Enter approximate monthly income" className="w-full pl-11 pr-4 py-3 bg-[#fcfcfc] border border-gray-200 rounded-xl focus:outline-none focus:border-[#5bc116] focus:ring-1 focus:ring-[#5bc116] transition-all" />
                  </div>
                </div>
                <div className="space-y-2 md:col-span-2">
                  <label className="text-[14px] font-bold text-gray-700 ml-1">Existing Loan</label>
                  <div className="relative">
                    <select defaultValue="" className="w-full px-4 py-3 bg-[#fcfcfc] border border-gray-200 rounded-xl focus:outline-none focus:border-[#5bc116] focus:ring-1 focus:ring-[#5bc116] transition-all appearance-none text-gray-600">
            ...
            <div>
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <textarea rows="4" placeholder="Tell us more about your requirement." className="w-full pl-11 pr-4 py-3 bg-[#fcfcfc] border border-gray-200 rounded-xl focus:outline-none focus:border-[#5bc116] focus:ring-1 focus:ring-[#5bc116] transition-all resize-none"></textarea>
                </div>
              </div>
            </div>

            <button type="button" className="w-full bg-[#5bc116] text-[#0b0f0e] font-bold text-lg py-4 rounded-xl flex items-center justify-center gap-2 hover:bg-[#4a9b12] transition-colors shadow-lg shadow-[#5bc116]/20 group">
              Submit & Continue
