...
const AboutTech = () => {
  return (
    <section className="w-full bg-[#F8FAFC] pt-20 pb-4 px-6 md:px-10 relative overflow-hidden">
      ...
      <div className="w-full px-6 lg:px-12 xl:px-16 mx-auto flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
        ...
        <div className="w-full lg:w-1/2">
          <h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-6 leading-tight">
            Technology That Makes <span className="text-[#0EA5E9]">Finance Simpler</span>
          </h2>
          ...
          <div className="bg-white border border-[#E0F2FE] shadow-sm rounded-2xl p-6 mb-8 inline-block">
            <h4 className="text-gray-900 font-bold mb-4 uppercase tracking-wider text-[12px]">Digital First. Customer Focused.</h4>
            <div className="flex flex-wrap items-center gap-2 text-[#0EA5E9] font-semibold text-[14px]">
        ...
        <div className="w-full lg:w-1/2">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 relative z-10">
            ...
            <div className="bg-white p-8 rounded-3xl shadow-xl shadow-green-900/5 border border-gray-100 flex flex-col items-center text-center transform md:translate-y-8">
              <div className="w-16 h-16 bg-[#FDFBF7] rounded-2xl flex items-center justify-center text-[#0EA5E9] mb-6">
                <Smartphone size={32} />
              </div>
