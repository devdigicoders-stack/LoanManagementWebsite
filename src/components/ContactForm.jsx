      ...
      <div className="max-w-6xl mx-auto flex flex-col lg:flex-row gap-16 items-start">
        ...
        <div className="w-full lg:w-[40%] flex flex-col">
          ...
          <div className="flex flex-col gap-8 mb-10">
            <div>
              <p className="text-slate-600 font-semibold text-[12px] uppercase tracking-wider mb-3">GET IN TOUCH</p>
              
              <div className="flex flex-col gap-5">
                <div className="flex items-center gap-4 group">
                  <div className="w-10 h-10 rounded-full bg-[#F8FAFC] border border-[#E0F2FE] flex items-center justify-center text-[#0EA5E9] group-hover:bg-[#0EA5E9] group-hover:text-white transition-colors shrink-0">
                    <Phone size={18} />
                  </div>
                ...
                <div className="flex items-start gap-4 group">
                  <div className="w-10 h-10 rounded-full bg-[#F8FAFC] border border-[#E0F2FE] flex items-center justify-center text-[#0EA5E9] group-hover:bg-[#0EA5E9] group-hover:text-white transition-colors shrink-0 mt-1">
                    <MapPin size={18} />
                  </div>
          ...
          <div>
            <p className="text-slate-600 font-semibold text-[12px] uppercase tracking-wider mb-4">FOLLOW US</p>
            <div className="flex items-center gap-3">
              <Link to="#" className="w-9 h-9 rounded-full bg-[#FDFBF7] flex items-center justify-center text-white hover:bg-[#0EA5E9] transition-colors">
