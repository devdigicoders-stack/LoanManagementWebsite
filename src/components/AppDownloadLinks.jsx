    ...
    <section className="w-full bg-[#f4fdf5] py-24 px-6 md:px-10 border-b border-[#e8fbe9]">
      <div className="max-w-5xl mx-auto text-center">
        ...
        <h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-6 leading-tight">
          ...
          <span className="text-[#5bc116]">Financial Journey Today</span>
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-3xl mx-auto">
          ...
          {/* Android */}
          <div className="bg-white p-8 rounded-3xl border border-[#e8fbe9] shadow-sm hover:-translate-y-2 transition-transform duration-300">
            <div className="w-16 h-16 bg-[#0b0f0e] text-[#5bc116] rounded-2xl flex items-center justify-center mx-auto mb-6">
            ...
            <Link 
              to="#"
              className="inline-flex items-center bg-black text-white rounded-xl px-5 py-2.5 hover:bg-gray-900 transition-colors border border-gray-800"
            >
              <div className="mr-3">
          ...
          {/* iOS */}
          <div className="bg-white p-8 rounded-3xl border border-[#e8fbe9] shadow-sm hover:-translate-y-2 transition-transform duration-300">
            <div className="w-16 h-16 bg-[#0b0f0e] text-white rounded-2xl flex items-center justify-center mx-auto mb-6">
