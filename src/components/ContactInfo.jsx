...
import { Phone, Mail, MapPin, Building, Clock, Briefcase, HelpCircle } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto space-y-16">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-6 leading-tight">
            Contact <span className="text-[#5bc116]">HAUS NUO-Pay</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow flex flex-col items-center text-center">
            ...
            <p className="text-[#5bc116] font-bold text-lg mb-2">
              <a href="tel:+919755766018">+91 9755 766 018</a>
            </p>
            <p className="text-gray-500 text-[14px] mb-4">
              <a href="mailto:customercare@hausnuo.com" className="hover:text-[#5bc116]">customercare@hausnuo.com</a>
            </p>
          ...
          <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow flex flex-col items-center text-center">
            ...
            <p className="text-gray-500 text-[14px] mb-4">
              <a href="mailto:nuo.secretarial@hausnuo.com" className="hover:text-[#5bc116]">nuo.secretarial@hausnuo.com</a>
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* Registered Office */}
          <div className="bg-[#0b0f0e] text-white p-8 rounded-3xl shadow-sm hover:shadow-md transition-shadow relative overflow-hidden">
            <div className="absolute top-0 right-0 p-8 opacity-10">
              <Building size={120} />
            </div>
            <div className="relative z-10">
              <div className="w-12 h-12 bg-[#5bc116]/20 border border-[#5bc116]/30 text-[#5bc116] rounded-xl flex items-center justify-center mb-6">
                <MapPin size={24} />
              </div>
              <h3 className="text-xl font-bold text-white mb-2">Registered Office</h3>
              <p className="text-[#5bc116] font-semibold text-[13px] mb-4 uppercase tracking-wider">(Hyderabad, Telangana)</p>
              ...
              <div className="space-y-2">
                <p className="text-gray-300 text-sm"><span className="text-gray-500">M:</span> +91 9755 766 018</p>
                <p className="text-gray-300 text-sm"><span className="text-gray-500">E:</span> haustouch@hausnuo.com</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-[#f0fbf0] border border-[#d3ecd3] p-8 rounded-3xl shadow-sm hover:shadow-md transition-shadow relative overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="w-12 h-12 bg-white border border-[#5bc116]/30 text-[#5bc116] rounded-xl flex items-center justify-center mb-6">
                <MapPin size={24} />
              </div>
              <h3 className="text-xl font-bold text-gray-900 mb-2">Operationally Headquarter Office</h3>
              <p className="text-[#5bc116] font-semibold text-[13px] mb-4 uppercase tracking-wider">(Bangaluru, Karnataka)</p>
              ...
              <div className="space-y-2">
                <p className="text-gray-700 text-sm"><span className="text-gray-400">M:</span> +91 9755 766 018</p>
                <p className="text-gray-700 text-sm"><span className="text-gray-400">E:</span> haustouch@hausnuo.com</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm text-center">
          <div className="w-16 h-16 bg-[#f4fdf5] border border-[#e8fbe9] text-[#5bc116] rounded-2xl flex items-center justify-center mx-auto mb-6">
            <Clock size={28} />
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8 max-w-4xl mx-auto">
            <div className="bg-gray-50 p-6 rounded-2xl border border-gray-100">
              ...
              <p className="text-[#5bc116] font-semibold mb-1">Mon - Sat: 10:30 AM to 08:00 PM</p>
            ...
            <div className="bg-gray-50 p-6 rounded-2xl border border-gray-100">
              ...
              <p className="text-[#5bc116] font-semibold mb-1">Mon - Sat: 10:00 AM to 06:30 PM</p>
              <p className="text-gray-500 text-[13px]">(Except Sunday & National Holidays)</p>
            </div>
          </div>
        </div>
        ...
        <div>
          <div className="text-center mb-10">
            <h3 className="text-3xl font-bold text-gray-900 mb-4">Our <span className="text-[#5bc116]">Branches</span></h3>
            <div className="w-16 h-1 bg-[#5bc116] mx-auto rounded-full"></div>
          </div>
            ...
            {branches.map((branch, idx) => (
              <div key={idx} className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
                <div className="flex items-center gap-3 mb-3">
                  <MapPin size={20} className="text-[#5bc116]" />
                  <h4 className="font-bold text-gray-900 text-lg">{branch.city}</h4>
                </div>
