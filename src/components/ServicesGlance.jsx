      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-start gap-12 lg:gap-20">
        ...
        <div className="w-full lg:w-1/3 sticky top-32">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6 leading-tight">
            One Platform. <br/>
            <span className="text-[#0EA5E9]">Multiple Financial Possibilities.</span>
          </h2>
          <button className="hidden lg:inline-flex items-center gap-2 bg-[#FDFBF7] text-slate-900 px-6 py-3 rounded-full font-bold hover:bg-[#E0F2FE] transition-colors group">
        ...
        <div className="w-full lg:w-2/3">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {glanceItems.map((item, index) => (
              <div key={index} className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm hover:border-[#0EA5E9] transition-colors">
                <div className="flex items-center gap-4 mb-4">
                  <div className="w-10 h-10 rounded-full bg-[#f0fbf0] text-[#0EA5E9] flex items-center justify-center shrink-0">
                    {item.icon}
                  </div>
