...
const GetStartedHero = () => {
  return (
    <section className="w-full bg-[#030706] pt-32 pb-24 px-6 md:px-10 relative overflow-hidden">
      ...
      <div className="absolute top-[-10%] right-[-10%] w-[600px] h-[600px] bg-[#5bc116] rounded-full blur-[180px] opacity-15 pointer-events-none"></div>
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        <h1 className="text-4xl md:text-5xl lg:text-7xl font-extrabold text-white mb-6 leading-tight tracking-wide">
          ...
          <span className="text-[#5bc116] drop-shadow-[0_0_20px_rgba(91,193,22,0.3)]">Finance Journey</span>
        </h1>
        
        <p className="text-gray-400 text-[16px] md:text-lg leading-relaxed mb-8 max-w-3xl mx-auto">
          Take the first step toward understanding your property and financial requirements.
        </p>
        <p className="text-gray-400 text-[16px] md:text-lg leading-relaxed mb-10 max-w-3xl mx-auto">
        ...
        <div className="text-xl md:text-2xl font-bold text-white mb-12">
          Explore Your Options. <span className="text-[#5bc116]">Share Your Requirement.</span> Take an Informed Step.
        </div>
