...
const ContactSocial = () => {
  return (
    <section className="w-full bg-[#FDFBF7] py-20 px-6 md:px-10 border-t border-[#E0F2FE]">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12">
        ...
        <div className="w-full md:w-1/2 flex flex-col md:items-end">
          ...
          <div className="flex gap-4">
            <a href="#" className="w-12 h-12 bg-[#111814] border border-[#E0F2FE] text-[#0EA5E9] rounded-full flex items-center justify-center hover:bg-[#0EA5E9] hover:text-slate-900 transition-colors group">
