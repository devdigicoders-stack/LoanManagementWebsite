      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12">
        ...
        <div className="w-full md:w-1/2 flex flex-col md:items-end">
          ...
          <div className="flex gap-4">
            <a href="#" className="w-12 h-12 bg-[#111814] border border-[#E0F2FE] text-[#0EA5E9] rounded-full flex items-center justify-center hover:bg-[#0EA5E9] hover:text-[#FDFBF7] transition-colors group">
