...
const ContactSocial = () => {
  return (
    <section className="w-full bg-[#FDFBF7] py-20 px-6 md:px-10 border-t border-slate-100">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12">
        
        {/* Connect Info */}
        <div className="w-full md:w-1/2">
          <div className="inline-flex items-center gap-2 text-[#0EA5E9] mb-4">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-start gap-3 text-slate-700">
              <MapPin size={18} className="text-[#0EA5E9] mt-1" />
        ...
        <div className="w-full md:w-1/2 flex flex-col md:items-end">
          ...
          <div className="flex gap-4">
            <a href="#" className="w-12 h-12 bg-[#F0F9FF] border border-[#0EA5E9]/20 text-[#0EA5E9] rounded-full shadow-sm flex items-center justify-center hover:bg-[#0EA5E9] hover:text-slate-900 transition-colors group">
