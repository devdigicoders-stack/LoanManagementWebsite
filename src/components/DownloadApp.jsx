...
const DownloadApp = () => {
  return (
    <section className="w-full bg-white py-16 px-6 md:px-10">
      <div className="max-w-7xl mx-auto rounded-[40px] relative overflow-hidden bg-[#f4fdf5] flex flex-col lg:flex-row shadow-[0_8px_30px_rgba(0,0,0,0.04)] border border-[#e8f5e9]">
        ...
        <div className="lg:w-1/2 p-8 md:p-12 lg:px-14 lg:py-12 flex flex-col justify-center relative z-10">
          <div className="inline-block bg-[#e4f6db] text-[#5bc116] rounded-full px-4 py-1.5 text-[11px] font-bold tracking-wider mb-6 w-max">
            DOWNLOAD OUR APP
          </div>
          
          <h2 className="text-3xl md:text-4xl lg:text-[40px] font-bold text-black mb-6 leading-[1.15]">
            Manage Your Payments <br />
            <span className="text-[#5bc116]">On The Go</span>
          </h2>
          ...
          <div className="flex flex-wrap lg:flex-nowrap items-center gap-3 lg:gap-4">
            ...
            {/* Google Play Button */}
            <button className="bg-black hover:bg-gray-900 text-white rounded-xl px-4 py-2 flex items-center gap-3 transition-transform hover:scale-105 duration-300">
              ...
              <div className="text-left">
                <div className="text-[9px] font-medium uppercase tracking-widest text-gray-300">GET IT ON</div>
            ...
            {/* App Store Button */}
            <button className="bg-black hover:bg-gray-900 text-white rounded-xl px-4 py-2 flex items-center gap-3 transition-transform hover:scale-105 duration-300">
              <div className="text-white flex items-center justify-center w-6 h-6 mb-1">
              ...
              <div className="text-left">
                <div className="text-[9px] font-medium uppercase tracking-widest text-gray-300">Download on the</div>
            ...
            <div className="hidden sm:flex bg-white p-1.5 rounded-xl shadow-lg border border-gray-100 items-center justify-center relative ml-1 lg:ml-2 group cursor-pointer transition-transform hover:scale-105 duration-300 shrink-0">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="bg-white p-0.5 rounded-[2px]">
                  <div className="w-3 h-3 bg-[#5bc116] rounded-[2px]"></div>
                </div>
              </div>
            </div>
