...
const ContactFinalCTA = () => {
  return (
    <section className="w-full bg-[#f4fdf5] py-24 px-6 md:px-10 relative overflow-hidden">
      <div className="max-w-4xl mx-auto relative z-10 text-center">
        ...
        <h2 className="text-3xl md:text-5xl font-extrabold text-gray-900 mb-6 leading-tight">
          ...
          <span className="text-[#5bc116]">Right Information</span>
        </h2>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <Link 
            to="/download" 
            className="w-full sm:w-auto bg-white text-gray-900 px-8 py-4 rounded-full font-bold flex items-center justify-center gap-2 border border-gray-200 hover:border-[#5bc116] hover:text-[#5bc116] transition-colors shadow-sm"
          >
            Download Our App
            <Download size={18} />
          </Link>
