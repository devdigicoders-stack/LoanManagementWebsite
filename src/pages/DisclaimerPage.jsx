    ...
    <div className="w-full bg-[#fcfcfc] min-h-screen pt-32 pb-20 px-6 md:px-10 text-gray-800">
      <div className="max-w-7xl mx-auto">
        <div className="mb-10 border-b border-gray-200 pb-8">
          ...
          <h1 className="text-3xl md:text-5xl font-extrabold text-[#0b0f0e] mb-3">Disclaimer</h1>
        ...
        <div className="w-full bg-white p-8 md:p-12 rounded-3xl shadow-[0_8px_30px_rgba(0,0,0,0.04)] border border-[#e8f5e9]">
          <div className="prose prose-green max-w-none prose-p:text-gray-500 prose-p:text-[14px] prose-p:leading-relaxed">
            ...
            <h2 className="mt-8 mb-4 flex items-center gap-3 text-xl font-extrabold text-[#0b0f0e] border-l-4 border-[#5bc116] pl-4">Completeness and Accuracy</h2>
            ...
            <h2 className="mt-8 mb-4 flex items-center gap-3 text-xl font-extrabold text-[#0b0f0e] border-l-4 border-[#5bc116] pl-4">Limitation of Liability</h2>
            ...
            <h2 className="mt-8 mb-4 flex items-center gap-3 text-xl font-extrabold text-[#0b0f0e] border-l-4 border-[#5bc116] pl-4">External Links &amp; Third-Party Sites</h2>
            ...
            <h2 className="mt-8 mb-4 flex items-center gap-3 text-xl font-extrabold text-[#0b0f0e] border-l-4 border-[#5bc116] pl-4">Website Availability</h2>
