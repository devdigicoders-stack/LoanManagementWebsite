    ...
    <div className="w-full bg-[#fcfcfc] min-h-screen pt-32 pb-20 px-6 md:px-10 text-gray-800">
      <div className="max-w-7xl mx-auto">
        <div className="mb-10 border-b border-gray-200 pb-8">
          ...
          <h1 className="text-3xl md:text-5xl font-extrabold text-[#0b0f0e] mb-3">Advisory Note</h1>
        ...
        <div className="w-full bg-white p-8 md:p-12 rounded-3xl shadow-[0_8px_30px_rgba(0,0,0,0.04)] border border-[#e8f5e9]">
          <div className="prose prose-green max-w-none prose-p:text-gray-500 prose-p:text-[14px] prose-p:leading-relaxed">
            ...
            <h2 className="mt-8 mb-4 flex items-center gap-3 text-xl font-extrabold text-[#0b0f0e] border-l-4 border-[#5bc116] pl-4">Purpose</h2>
            ...
            <h2 className="mt-8 mb-4 flex items-center gap-3 text-xl font-extrabold text-[#0b0f0e] border-l-4 border-[#5bc116] pl-4">Modus Operandi</h2>
            ...
            <h2 className="mt-8 mb-4 flex items-center gap-3 text-xl font-extrabold text-[#0b0f0e] border-l-4 border-[#5bc116] pl-4">Steps to be taken in Case of Receipt of Any Such Communication</h2>
            <div className="bg-[#f4fdf5] p-6 rounded-xl border border-[#c3f2cd] mt-6">
              <ul className="space-y-4">
                <li className="flex gap-3 items-start">
                  <CheckCircle2 className="text-[#5bc116] shrink-0 mt-0.5" size={18} />
                  <span className="text-[#2e5e15] font-medium text-sm">Check if the Name of the Company is Genuine. If the Name of the Company in Such Advertisement is Not by NuoG, it is Likely to be Fraudulent.</span>
                </li>
                <li className="flex gap-3 items-start">
                  <CheckCircle2 className="text-[#5bc116] shrink-0 mt-0.5" size={18} />
                  <span className="text-[#2e5e15] font-medium text-sm">Check whether the e-Mail Address given is Genuine.</span>
                </li>
                <li className="flex gap-3 items-start">
                  <CheckCircle2 className="text-[#5bc116] shrink-0 mt-0.5" size={18} />
                  <span className="text-[#2e5e15] font-medium text-sm">Check the e-Mail id of the Sender.</span>
                </li>
                <li className="flex gap-3 items-start">
                  <CheckCircle2 className="text-[#5bc116] shrink-0 mt-0.5" size={18} />
                  <span className="text-[#2e5e15] font-medium text-sm">Check whether the Bank Accounts into which the Amount is Asked to be Credited are in Individual Names. If yes, it is Not a Genuine NuoG Account.</span>
                </li>
                <li className="flex gap-3 items-start">
                  <CheckCircle2 className="text-[#5bc116] shrink-0 mt-0.5" size={18} />
                  <span className="text-[#2e5e15] font-medium text-sm">Once You are Sure as to the Fraudulent Nature of the Advertisement, Report the Same to the Police and Intimate us of the Same by e-Mail at <a href="mailto:support@nuobnk.com" className="font-bold underline hover:text-[#1a380b]">support@nuobnk.com</a> (or support@nghpl.com).</span>
                </li>
              </ul>
            </div>
