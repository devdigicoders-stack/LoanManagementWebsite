    ...
    <div className="w-full bg-[#fcfcfc] min-h-screen pt-32 pb-20 px-6 md:px-10 text-gray-800">
      <div className="max-w-7xl mx-auto">
        <div className="mb-10 border-b border-gray-200 pb-8">
          ...
          <h1 className="text-3xl md:text-5xl font-extrabold text-[#0b0f0e] mb-3">NACH/eNACH Cancellation</h1>
        ...
        <div className="w-full bg-white p-8 md:p-12 rounded-3xl shadow-[0_8px_30px_rgba(0,0,0,0.04)] border border-[#e8f5e9]">
          <div className="prose prose-green max-w-none prose-p:text-gray-500 prose-p:text-[14px] prose-p:leading-relaxed">
            <h2 className="mt-4 mb-4 flex items-center gap-3 text-2xl font-extrabold text-[#0b0f0e] border-l-4 border-[#5bc116] pl-4">NACH/eNACH CANCELLATION FOR NUOG MONEY &amp; NUO-PAY LOANS</h2>
            ...
            <div className="bg-[#f4fdf5] p-6 rounded-xl border border-[#c3f2cd] my-8">
              ...
              <p className="text-[#3b791b] mb-2 text-[14px]">For any query on eNACH, please write to <a href="mailto:enach.support@nuobnk.com" className="font-bold hover:underline">enach.support@nuobnk.com</a> or call us on <strong className="font-bold">9755 766 018</strong> (Monday to Friday - 10 AM to 06 PM) or visit your nearest NuoG Branch.</p>
