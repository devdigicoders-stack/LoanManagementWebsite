    ...
    <div className="w-full bg-[#fcfcfc] min-h-screen pt-32 pb-20 px-6 md:px-10 text-gray-800">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-10 border-b border-gray-200 pb-8">
          ...
          <h1 className="text-3xl md:text-5xl font-extrabold text-[#FDFBF7] mb-3">
            Privacy Policy
          </h1>
        ...
        <div className="flex flex-col lg:flex-row gap-10 relative items-start">
          ...
          <div className="w-full lg:w-[70%] bg-white p-8 md:p-12 rounded-3xl shadow-[0_8px_30px_rgba(0,0,0,0.04)] border border-[#e8f5e9]">
            <div className="max-w-none text-[15px] text-gray-600 leading-relaxed [&>p]:mb-5 [&>ul]:mb-5 [&>ol]:mb-5 [&>ul]:pl-5 [&>ol]:pl-5 [&>ul>li]:mb-2 [&>ol>li]:mb-2 [&>ul>li]:list-disc [&>ol>li]:list-decimal [&>ul]:list-disc [&>ol]:list-decimal">
              ...
              {/* Section 1 */}
              <h2 id="section-1" className="scroll-mt-32 mt-12 mb-4 flex items-center gap-3 text-2xl font-extrabold text-[#FDFBF7] border-l-4 border-[#0EA5E9] pl-4">1. CONSENT</h2>
              <p>
              ...
              {/* Section 2 */}
              <h2 id="section-2" className="scroll-mt-32 mt-12 mb-4 flex items-center gap-3 text-2xl font-extrabold text-[#FDFBF7] border-l-4 border-[#0EA5E9] pl-4">2. INFORMATION COLLECTED AND USED BY HAUS Money &amp; NUO-Pay</h2>
              ...
              <h3 className="mt-6 mb-3 text-base font-bold text-[#FDFBF7] uppercase tracking-wide">Data provided by you</h3>
              <ol>
              ...
              <h3 className="mt-6 mb-3 text-base font-bold text-[#FDFBF7] uppercase tracking-wide">Information we collect about you and how we use that information</h3>
              <ul>
              ...
              {/* Section 3 */}
              <h2 id="section-3" className="scroll-mt-32 mt-12 mb-4 flex items-center gap-3 text-2xl font-extrabold text-[#FDFBF7] border-l-4 border-[#0EA5E9] pl-4">3. PURPOSE OF INFORMATION COLLECTED BY HAUS Money &amp; NUO-Pay</h2>
              ...
              {/* Section 4 */}
              <h2 id="section-4" className="scroll-mt-32 mt-12 mb-4 flex items-center gap-3 text-2xl font-extrabold text-[#FDFBF7] border-l-4 border-[#0EA5E9] pl-4">4. DATA RETENTION AND DELETION</h2>
              <p>
              ...
              {/* Section 5 */}
              <h2 id="section-5" className="scroll-mt-32 mt-12 mb-4 flex items-center gap-3 text-2xl font-extrabold text-[#FDFBF7] border-l-4 border-[#0EA5E9] pl-4">5. PROCEDURE FOR DATA DESTRUCTION AND REMOVAL OF USER DETAILS FROM THE RECORD</h2>
              <p>
              ...
              {/* Section 6 */}
              <h2 id="section-6" className="scroll-mt-32 mt-12 mb-4 flex items-center gap-3 text-2xl font-extrabold text-[#FDFBF7] border-l-4 border-[#0EA5E9] pl-4">6. SPECIFIC CONSENT</h2>
              <p>
              ...
              {/* Section 7 */}
              <h2 id="section-7" className="scroll-mt-32 mt-12 mb-4 flex items-center gap-3 text-2xl font-extrabold text-[#FDFBF7] border-l-4 border-[#0EA5E9] pl-4">7. SHARING OF INFORMATION</h2>
              <p>
              ...
              {/* Section 8 */}
              <h2 id="section-8" className="scroll-mt-32 mt-12 mb-4 flex items-center gap-3 text-2xl font-extrabold text-[#FDFBF7] border-l-4 border-[#0EA5E9] pl-4">8. STANDARDS FOR HANDLING DATA BREACHES</h2>
              <p>
              ...
              {/* Section 9 */}
              <h2 id="section-9" className="scroll-mt-32 mt-12 mb-4 flex items-center gap-3 text-2xl font-extrabold text-[#FDFBF7] border-l-4 border-[#0EA5E9] pl-4">9. PROCEDURE FOR CORRECTING INACCURACIES IN YOUR INFORMATION</h2>
              <p>
              ...
              {/* Section 10 */}
              <h2 id="section-10" className="scroll-mt-32 mt-12 mb-4 flex items-center gap-3 text-2xl font-extrabold text-[#FDFBF7] border-l-4 border-[#0EA5E9] pl-4">10. CHANGES IN PRIVACY POLICY</h2>
              <p>
              ...
              {/* Section 11 */}
              <h2 id="section-11" className="scroll-mt-32 mt-12 mb-4 flex items-center gap-3 text-2xl font-extrabold text-[#FDFBF7] border-l-4 border-[#0EA5E9] pl-4">11. INCORPORATION OF PRIVACY POLICY TO THE TERMS OF USE</h2>
              <p>
                This Privacy Policy is incorporated to the Terms of use (Terms) and other specific terms of this Website/Services/Account.
              </p>

              {/* Section 12 */}
              <h2 id="section-12" className="scroll-mt-32 mt-12 mb-4 flex items-center gap-3 text-2xl font-extrabold text-[#FDFBF7] border-l-4 border-[#0EA5E9] pl-4">12. GRIEVANCE REDRESSAL</h2>
              <p>
              ...
              {/* Section 13 */}
              <h2 id="section-13" className="scroll-mt-32 mt-12 mb-4 flex items-center gap-3 text-2xl font-extrabold text-[#FDFBF7] border-l-4 border-[#0EA5E9] pl-4">13. REPORTING TO CREDIT INFORMATION COMPANIES (CICS)</h2>
              <p>
              ...
              {/* Section 14 */}
              <h2 id="section-14" className="scroll-mt-32 mt-12 mb-4 flex items-center gap-3 text-2xl font-extrabold text-[#FDFBF7] border-l-4 border-[#0EA5E9] pl-4">14. WEBSITE DISCLOSURES</h2>
              <ul>
              ...
              {/* Section 15 */}
              <h2 id="section-15" className="scroll-mt-32 mt-12 mb-4 flex items-center gap-3 text-2xl font-extrabold text-[#FDFBF7] border-l-4 border-[#0EA5E9] pl-4">15. LIST OF THIRD PARTIES</h2>
