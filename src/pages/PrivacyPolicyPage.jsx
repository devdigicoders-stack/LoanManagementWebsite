        ...
        <div className="flex flex-col lg:flex-row gap-10 relative items-start">
          ...
          <div className="w-full lg:w-[70%] bg-white p-8 md:p-12 rounded-3xl shadow-[0_8px_30px_rgba(0,0,0,0.04)] border border-[#e8f5e9]">
            <div className="max-w-none text-[15px] text-gray-600 leading-relaxed [&>p]:mb-5 [&>ul]:mb-5 [&>ol]:mb-5 [&>ul]:pl-5 [&>ol]:pl-5 [&>ul>li]:mb-2 [&>ol>li]:mb-2 [&>ul>li]:list-disc [&>ol>li]:list-decimal [&>ul]:list-disc [&>ol]:list-decimal">
              ...
              {/* Introduction Text */}
              <p>
                This website <a href="https://hausnuo.com" target="_blank" rel="noreferrer" className="text-[#0EA5E9] no-underline hover:underline font-semibold">(hausnuo.com)</a>, the HAUS Money & NUO-Pay Mobile Application and other related/associated internet based applications (collectively referred to as “Website” or “App”) is owned and operated by <strong>NuoG Housing Payment&apos;s Limited</strong>, (hereinafter referred to as “We”, or “Us” or “Our”), a company incorporated under Companies Act, 1956 and having its registered office at Srinivas Nagar, Kapra, Dr. AS Rao Nagar, Medchal-Malkajgiri, Secunderabad, Hyderabad - 500 062, TG, India.
              </p>
              <p>
              ...
              <ul>
                <li>All digital lending products and its Digital Lending Applications - <a href="https://hausnuo.com/" target="_blank" rel="noreferrer" className="text-[#0EA5E9] hover:underline">https://hausnuo.com/</a></li>
                <li>Lending Service Providers (LSPs) and details of the Digital Lendings Applications of LSPs - <a href="https://hausnuo.com/partnership/" target="_blank" rel="noreferrer" className="text-[#0EA5E9] hover:underline">https://hausnuo.com/partnership/</a></li>
                <li>Customer care particulars and internal grievance redressal mechanism - <a href="https://hausnuo.com/contact-us/" target="_blank" rel="noreferrer" className="text-[#0EA5E9] hover:underline">https://hausnuo.com/contact-us/</a> or <a href="https://hausnuo.com/ombudsman/" target="_blank" rel="noreferrer" className="text-[#0EA5E9] hover:underline">https://hausnuo.com/ombudsman/</a></li>
