        ...
        <div className="flex flex-col lg:flex-row gap-10 relative items-start">
          ...
          <div className="w-full lg:w-[70%] bg-white p-8 md:p-12 rounded-3xl shadow-[0_8px_30px_rgba(0,0,0,0.04)] border border-[#e8f5e9]">
            <div className="max-w-none text-[15px] text-gray-600 leading-relaxed [&>p]:mb-5 [&>ul]:mb-5 [&>ol]:mb-5 [&>ul]:pl-5 [&>ol]:pl-5 [&>ul>li]:mb-2 [&>ol>li]:mb-2 [&>ul>li]:list-disc [&>ol>li]:list-decimal [&>ul]:list-disc [&>ol]:list-decimal">
              ...
              <ul>
                <li>All digital lending products and its Digital Lending Applications - <a href="https://www.nghpl.com/" target="_blank" rel="noreferrer" className="text-[#5bc116] hover:underline">https://www.nghpl.com/</a></li>
                <li>Lending Service Providers (LSPs) and details of the Digital Lendings Applications of LSPs - <a href="https://www.nghpl.com/partnership/" target="_blank" rel="noreferrer" className="text-[#5bc116] hover:underline">https://www.nghpl.com/partnership/</a></li>
                <li>Customer care particulars and internal grievance redressal mechanism - <a href="https://www.nghpl.com/contact-us/" target="_blank" rel="noreferrer" className="text-[#5bc116] hover:underline">https://www.nghpl.com/contact-us/</a> or <a href="https://www.nghpl.com/ombudsman/" target="_blank" rel="noreferrer" className="text-[#5bc116] hover:underline">https://www.nghpl.com/ombudsman/</a></li>
