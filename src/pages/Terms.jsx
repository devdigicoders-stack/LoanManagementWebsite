      ...
      <div className="max-w-7xl mx-auto">
        ...
        {/* Legal Disclaimer & Registered Office */}
          <div className="mt-12 space-y-5">
            ...
            {/* Disclaimer */}
            <div className="bg-[#f4fdf5] border border-[#d4f0d4] rounded-2xl p-6 text-[13px] text-gray-600 leading-relaxed">
              <span className="text-[#4a9b12] font-bold">HAUS NUO-Pay</span> — Use of the Technologies Digital Partner Platform Journey Built By, Operated &amp; Managed Under the Trade Name &amp; Brand Owned by{' '}
              <span className="font-semibold text-gray-900">NuoG Housing Payment's Limited &amp; NuoG Softech Limited.</span>{' '}
              We Partner with Multiple Private Banks &amp; NBFCs Including Our NBFC Subsidiary{' '}
              <span className="font-semibold text-gray-900">Aadi Fincash Private Limited,</span>{' '}
            ...
            {/* Registered Office */}
            <div className="bg-white border border-gray-200 rounded-2xl p-6 flex flex-col md:flex-row md:items-start gap-4 shadow-sm">
