    ...
    <div className="w-full bg-[#fcfcfc] min-h-screen pt-32 pb-20 px-6 md:px-10 text-gray-800">
      <div className="max-w-7xl mx-auto">
        <div className="mb-10 border-b border-gray-200 pb-8">
          ...
          <h1 className="text-3xl md:text-5xl font-extrabold text-[#FDFBF7] mb-3">Terms & Conditions</h1>
        ...
        <div className="flex flex-col lg:flex-row gap-10">
          ...
          <div className="w-full lg:w-[70%] bg-white p-8 md:p-12 rounded-3xl shadow-[0_8px_30px_rgba(0,0,0,0.04)] border border-[#e8f5e9]">
            <div className="prose prose-green max-w-none prose-headings:text-[#FDFBF7] prose-h2:text-xl prose-h2:font-bold prose-h2:mt-10 prose-h2:mb-4 prose-p:text-gray-500 prose-p:text-[14px] prose-p:leading-relaxed prose-li:text-gray-500 prose-li:text-[14px]">
              ...
              {/* Section 1 */}
              <h2 id="section-1" className="scroll-mt-32 mt-12 mb-4 flex items-center gap-3 text-2xl font-extrabold text-[#FDFBF7] border-l-4 border-[#0EA5E9] pl-4">1. INTRODUCTION</h2>
              ...
              {/* Section 2 */}
              <h2 id="section-2" className="scroll-mt-32 mt-12 mb-4 flex items-center gap-3 text-2xl font-extrabold text-[#FDFBF7] border-l-4 border-[#0EA5E9] pl-4">2. USING THE WEBSITE/ SERVICES</h2>
              ...
              {/* Section 3 */}
              <h2 id="section-3" className="scroll-mt-32 mt-12 mb-4 flex items-center gap-3 text-2xl font-extrabold text-[#FDFBF7] border-l-4 border-[#0EA5E9] pl-4">3. GRANT OF AUTHORITY</h2>
              ...
              {/* Section 4 */}
              <h2 id="section-4" className="scroll-mt-32 mt-12 mb-4 flex items-center gap-3 text-2xl font-extrabold text-[#FDFBF7] border-l-4 border-[#0EA5E9] pl-4">4. PROPRIETARY RIGHTS</h2>
              ...
              {/* Section 5 */}
              <h2 id="section-5" className="scroll-mt-32 mt-12 mb-4 flex items-center gap-3 text-2xl font-extrabold text-[#FDFBF7] border-l-4 border-[#0EA5E9] pl-4">5. PROHIBITED CONDUCT</h2>
              ...
              {/* Section 6 */}
              <h2 id="section-6" className="scroll-mt-32 mt-12 mb-4 flex items-center gap-3 text-2xl font-extrabold text-[#FDFBF7] border-l-4 border-[#0EA5E9] pl-4">6. DISPLAY/ ADVERTISEMENTS/ WEB LINKS</h2>
              ...
              {/* Section 7 */}
              <h2 id="section-7" className="scroll-mt-32 mt-12 mb-4 flex items-center gap-3 text-2xl font-extrabold text-[#FDFBF7] border-l-4 border-[#0EA5E9] pl-4">7. INACCURACIES</h2>
              ...
              {/* Section 8 */}
              <h2 id="section-8" className="scroll-mt-32 mt-12 mb-4 flex items-center gap-3 text-2xl font-extrabold text-[#FDFBF7] border-l-4 border-[#0EA5E9] pl-4">8. SECURITY</h2>
              ...
              {/* Section 9 */}
              <h2 id="section-9" className="scroll-mt-32 mt-12 mb-4 flex items-center gap-3 text-2xl font-extrabold text-[#FDFBF7] border-l-4 border-[#0EA5E9] pl-4">9. DISCLAIMER OF WARRANTY</h2>
              ...
              {/* Section 10 */}
              <h2 id="section-10" className="scroll-mt-32 mt-12 mb-4 flex items-center gap-3 text-2xl font-extrabold text-[#FDFBF7] border-l-4 border-[#0EA5E9] pl-4">10. LIMITATION OF LIABILITY</h2>
              ...
              {/* Section 11 */}
              <h2 id="section-11" className="scroll-mt-32 mt-12 mb-4 flex items-center gap-3 text-2xl font-extrabold text-[#FDFBF7] border-l-4 border-[#0EA5E9] pl-4">11. USE INFORMATION ON THIS SERVICES</h2>
              ...
              {/* Section 12 */}
              <h2 id="section-12" className="scroll-mt-32 mt-12 mb-4 flex items-center gap-3 text-2xl font-extrabold text-[#FDFBF7] border-l-4 border-[#0EA5E9] pl-4">12. GOVERNING LAW AND JURISDICTION</h2>
              ...
              {/* Section 13 */}
              <h2 id="section-13" className="scroll-mt-32 mt-12 mb-4 flex items-center gap-3 text-2xl font-extrabold text-[#FDFBF7] border-l-4 border-[#0EA5E9] pl-4">13. DETAILS OF GRIEVANCE OFFICER</h2>
              ...
              <div className="bg-[#f0fbf0] p-6 rounded-xl border border-[#d3ecd3] my-6 text-[#FDFBF7]">
              ...
              {/* Section 14 */}
              <h2 id="section-14" className="scroll-mt-32 mt-12 mb-4 flex items-center gap-3 text-2xl font-extrabold text-[#FDFBF7] border-l-4 border-[#0EA5E9] pl-4">14. BREACH OF THE TERMS</h2>
              ...
              {/* Section 15 */}
              <h2 id="section-15" className="scroll-mt-32 mt-12 mb-4 flex items-center gap-3 text-2xl font-extrabold text-[#FDFBF7] border-l-4 border-[#0EA5E9] pl-4">15. FEEDBACK</h2>
              ...
              {/* Section 16 */}
              <h2 id="section-16" className="scroll-mt-32 mt-12 mb-4 flex items-center gap-3 text-2xl font-extrabold text-[#FDFBF7] border-l-4 border-[#0EA5E9] pl-4">16. MISCELLANEOUS</h2>
